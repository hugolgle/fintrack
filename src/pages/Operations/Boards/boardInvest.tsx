...
export default function BoardInvest() {
  ...
  const firstDateByTitle = getInvest.reduce((acc: any, investment: any) => {
  ...
  const uniqueInvest = getInvest.filter((investment: any) => {
    return (
  ...
  const investmentCountByTitle = getInvest.reduce(
      ...
      <section>
        ...
        <div className="flex flex-col w-full justify-center gap-4 animate-fade">
          ...
          <div className="flex flex-wrap gap-4 justify-center mb-4">
            {uniqueInvest.map(({ titre, type, date }: any, index: number) => {
