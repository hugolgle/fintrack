...
import { addCredit } from "../../Service/Credit.service";
...
export function FormCredit({ refetch, editMode }) {
  ...
  useEffect(() => {
    ...
    if (
      ...
      if (monthlyRate > 0) {
        ...
        // Si le taux est de 0%, on divise simplement le montant par la durée
