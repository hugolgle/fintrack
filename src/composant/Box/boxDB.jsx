    ...
    <>
      ...
      <div className="flex flex-col gap-4 h-full">
        <div className="flex flex-row gap-4 h-1/2">
          <div className="flex flex-col w-full h-full bg-green-600 py-3 rounded-lg items-center justify-evenly">
            <p className="font-thin">Recettes</p>
            <p className="font-thin italic text-xl">{props.amountRevenue}</p>
          </div>
          <div className="flex flex-col w-full h-full bg-red-600 py-3 rounded-lg items-center justify-evenly">
            <p className="font-thin">Dépenses</p>
            <p className="font-thin italic text-xl">{props.amountExpense}</p>
          </div>
        </div>
        <div className="flex flex-row gap-4 h-1/2">
          <div className="flex flex-row w-full h-full bg-zinc-600 py-3 rounded-lg items-center justify-evenly">
